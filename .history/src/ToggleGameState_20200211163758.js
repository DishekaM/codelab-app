...
function ToggleGameState({gameState, setGameState, challenge, setChallenge}) {
  ...
  function updateGameState(challengeSetting, challenge) {
    ...
    else if(challenge === CHALLENGES.CHALLENGE_2){
        setChallenge(CHALLENGES.CHALLENGE_2);
      }
    else if(challenge === CHALLENGES.CHALLENGE_3){
        setChallenge(CHALLENGES.CHALLENGE_3);
      }
      setGameState(GAME_STATE.CHALLENGES);
    ...
    else if ( !(challengeSetting) && (gameState === GAME_STATE.CHALLENGES) ) {
