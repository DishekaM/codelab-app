...
let Node = function() {
  ...
  let Trie = function() {
    ...
    this.print = function() {
      ...
      search_word(this.root, new String());
      return words.length > 0 ? words : null;
    };
  }
  //Dfs function that is going to search the grid for words
  function dfs(grid, visited,row,c,gridword,myTrie,wordBank){  
    ...
    dfs(grid,visited,r + 1,col + 1,gridword,myTrie,wordBank); //rightdown
